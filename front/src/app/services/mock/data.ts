...
export const mockRestaurants: Restaurant[] = [
  ...
  },
  {
    Id: 'rest-pending-1',
    Name: 'کافه آرتاویل',
    Description: 'کافه‌ای دنج با منوی متنوع نوشیدنی‌های گرم و سرد',
    ...
    Image: '/images/restaurant-1.jpg',
    MenuItems: [],
    Tables: [{ Id: 't1', RestaurantId: 'rest-pending-1', TableNumber: 1, Capacity: 4 }],
    rating: 0, reviewCount: 0, priceLevel: 2,
  },
  {
    Id: 'rest-pending-2',
    Name: 'رستوران مهراب',
    Description: 'رستوران خانوادگی با غذاهای اصیل ایرانی',
