...
{
    /// <inheritdoc />
    public partial class AddUniqueReservationIndex : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Restaurants_MediaAssets_CoverImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_MediaAssets_ImageId",
                        column: x => x.ImageId,
                        principalTable: "MediaAssets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RestaurantImages_MediaAssets_MediaAssetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_Date_ReminderSent",
                table: "Reservations",
                columns: new[] { "ReservationDate", "ReminderSent" });

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_RestaurantId_Date",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantImages_MediaAssetId",
...
");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
    DROP INDEX IF EXISTS ""IX_Reservations_NoDoubleBook"";
");
        }
    }
}
